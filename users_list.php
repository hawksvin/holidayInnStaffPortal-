...
if($total_results = $db->getRow("SELECT COUNT(*) as count FROM `".MLS_PREFIX."users` ?p", $where)->count) {
    ...
    foreach($data as $u) {
      ...
      <div class='thumbnail clearfix'>
    	<a href='$set->url/profile.php?u=$u->userid'><img src='img/default-avatar.png' width='80' alt='".$options->html($u->username)."' class='pull-left clearfix' style='margin-right:10px'>
